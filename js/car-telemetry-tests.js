...
function testRunner() {
    ...
    console.log("passed 'returns valid one decimal place mileage': " + getCarTelemetry_GivenNonNumericBooleanWithDecimals_ReturnsStringMessage());
...
function getCarTelemetry_GivenNonNumericBooleanWithDecimals_ReturnsStringMessage(){
    // Arrange
    const car = {
        mileage: 345345.45535
