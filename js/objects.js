(function() {
     ...
     */
    // key points
        //1. heb has an offer for thode who spend $200+
        //2. that offer is that they grt 12% off
    // personal ToDo
        //1. use for each to iterate through shoppers
        //2. display current total
        //3. write a conditional with following:
        //- if shopper amount is > 200 apply and show discount
        //- if shopper amount is < 200 then return a message of "no discount to br found"
    ...
    shoppers.forEach(function (shopper) {
        ...
        if(shopper.amount > 200){
            return console.log(shopper.amount * .88);
        }else{
